...
Copyright 2022-2026 Steven Mycynek -- portions (c) 2012 kanda and matsuda
...
- Uses a modern framework (Angular 21)
...
from _WebGL Programming Guide_ and did a rough port to TypeScript to make them a little nicer to work with in VS Code and Angular.
...
- https://stevenvictor.net/glta/models/models/teapot.obj
- https://stevenvictor.net/glta/models/models/skull.obj
